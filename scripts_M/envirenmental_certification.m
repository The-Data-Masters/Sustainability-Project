let
    ...
    #"Valeur remplacée2" = Table.ReplaceValue(#"Valeur remplacée1","FSSC 22000","ISO 14001",Replacer.ReplaceText,{"Environmental_Certifications"}),
    #"Valeur remplacée3" = Table.ReplaceValue(#"Valeur remplacée2","2005","Agriculture Biologique",Replacer.ReplaceText,{"Environmental_Certifications"})
in
    #"Valeur remplacée3"